...
def handle_review_comment(payload: dict) -> tuple:
    ...
    if "Reply generated by codebot" in comment_body or "codebot 🤖" in comment_body:
        current_app.logger.info("Ignoring codebot's own comment (detected by signature)")
...
def handle_review(payload: dict) -> tuple:
    ...
    if "Reply generated by codebot" in review_body or "codebot 🤖" in review_body:
        current_app.logger.info("Ignoring codebot's own review (detected by signature)")
